...
class ProductsServiceTest {
    ...
    void testGetById_NotFound() {
        ...
        assertThrows(ResponseStatusException.class, () -> productService.getbyid(100));
    }
    ...
    void testUpdate_NotFound() {
        Products updatedData = new Products();
        when(productsRepo.findById(100)).thenReturn(Optional.empty());
        assertThrows(ResponseStatusException.class, () -> productService.update(100, updatedData));
    }

    @Test
    void testDelete_Success() {
        when(productsRepo.existsById(100)).thenReturn(true);
        doNothing().when(productsRepo).deleteById(100);
    ...
    void testDelete_NotFound() {
        ...
        assertThrows(ResponseStatusException.class, () -> productService.delete(100));
    }
    ...
    void testPartialUpdate_NameOnly() {
        ...
        assertEquals("Laptop Pro", updated.getName()); //giving new product name 
        //assertEquals(10, updated.getStock_quantity()); //Matching with initial stock optional for writing
    }
